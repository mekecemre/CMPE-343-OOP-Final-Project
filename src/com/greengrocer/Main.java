 ...
 * This JavaFX application provides a complete shopping system for a local greengrocer
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            // Add CSS stylesheet
            scene.getStylesheets().add(getClass().getResource("/com/greengrocer/styles/application.css").toExternalForm());
